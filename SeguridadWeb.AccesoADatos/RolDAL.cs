...
namespace SeguridadWeb.AccesoADatos
{
    public class RolDAL
    {
        ...
        public static async Task<List<Rol>> ObtenerTodosdAsync()
        {
        ...
        internal static IQueryable<Rol> QuerySelec(IQueryable<Rol> pQuery, Rol pRol)
        {
            if (pRol.Id > 0)
